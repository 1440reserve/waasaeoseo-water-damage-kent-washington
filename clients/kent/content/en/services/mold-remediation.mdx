...
image: "photos/service-mold-remediation.jpg"
imageAlt: "Mold spreading across a tiled bathroom wall"
...
quickAnswer: "If you see or smell mold in your Kent home after a leak or flood, keep the area closed off, avoid disturbing it, and call us. The local crew inspects, finds the moisture feeding the growth, and sets up containment before any cleanup, and most emergency calls have help moving within the hour."
icon: mold
order: 4
highlights:
...
processSteps:
  ...
  - title: "Dry and prevent"
    description: "The crew dries the structure and corrects the moisture problem so it does not return. This step is what separates real remediation from a quick wipe-down that comes back in a month."
